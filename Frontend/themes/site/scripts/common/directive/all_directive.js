                ...
                return {
                    ...
                    controller: ['$scope', 'util', '$timeout', function ($scope, util, $timeout) {
                            ...
                            $scope.loadData = function () {
                                util.callRequest('http://localhost:8080/ecommerce-rest-api/api/v1/1/theme/slider', "GET", null, true).then(function (data) {
...
//                                        $scope.$broadcast('priceRangeResult', result);
                            ...
                            $scope.loadData = function () {
                                ...
                                util.callRequest('categories/list', 'GET', paramCategory).then(function (data) {
                                    ...
                                    //console.log('categories/list',data.data.content);
                                    $scope.categories = sortOutAllCategories(data.data.content, null);
                                    console.log('$scope.categories',$scope.categories);
                                });

                                // load brands
                                util.callRequest('http://localhost:8080/ecommerce-rest-api/api/v1/1/products', "GET", null, true).then(function (data) {
