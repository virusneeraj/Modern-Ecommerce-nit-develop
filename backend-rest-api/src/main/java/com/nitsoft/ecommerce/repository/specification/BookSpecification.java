...
public class BookSpecification implements Specification<Book> {
    ...
    public BookSpecification(long companyId, long categoryId, long attributeId, String searchKey, double minPrice, double maxPrice, int minRank, int maxRank, int sortCase, boolean isAscSort) {
