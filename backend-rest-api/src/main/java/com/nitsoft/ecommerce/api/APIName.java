...
public class APIName {
    ...
    // book api links
    public static final String BOOKS = VERSION + "/books";
    public static final String BOOKS_BY_CATEGORY = "/category";
    public static final String BOOK_BY_ID = "/detail/{book_id}";
    public static final String BOOK_BY_IDS = "/list";
    public static final String BOOKS_FILTER_LIST = "/filter";
    public static final String BOOK_DETAILS = "/bookdetails/{book_id}";
    public static final String BOOK_ATTRIBUTES = VERSION + "/bookattributes";
    public static final String BOOK_CREATE = "/create";
    public static final String BOOK_BATCH_CREATE = "/batch/create";
    public static final String BOOKS_DELETE = "/delete";
    public static final String BOOK_UPDATE = "/update";
    public static final String BOOK_UPLOAD = "/upload";
    ...
    //Theme data API
    public static final String THEME_API = "/theme";
    public static final String SLIDER_DATA = "/slider";
    public static final String CREATE_SLIDER = "/slider/create";
    public static final String UPDATE_SLIDER = "/slider/update";
    public static final String GET_SLIDER = "/slider/{slider_id}";
    public static final String DELETE_SLIDER = "/slider/{slider_id}";
}
