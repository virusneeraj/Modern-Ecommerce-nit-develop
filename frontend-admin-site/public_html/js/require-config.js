...
require.config({
    ...
    paths: {
        ...
        ng_base64: 'libs/angular-base64.min',
        dropify: '../vendors/dropify/dist/js/dropify.min',
    ...
    shim: {
        ...
        // Main module
        'app': ['angular_route', 'angular_sanitize', 'angular_tags_input', 'angular_cookie', 'ng_datepicker', 'ng_base64', 'dropify', 'angular_date_picker', 'angular_animate', 'ui_router', 'ui_select', 'ng_i18next', 'oc_lazyload', 'theme', 'toastr', 'lodash', 'session', 'angular_bootstrap']
    },
    priority: [
        'jquery', 'angular'
    ]
