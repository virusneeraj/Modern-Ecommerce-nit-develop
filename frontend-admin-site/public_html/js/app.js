        ...
        'ngTagsInput'
            ...
            .config(['$ocLazyLoadProvider', 'AppConfig', function ($ocLazyLoadProvider, AppConfig) {
                    ...
                    var modules = [
                        ...
                        {
                            name: 'booksListModule',
                            files: [
                                'vendors/iCheck/skins/flat/blue.css',
                                'vendors/iCheck/icheck.min.js',
                                'js/common/directives/icheck.js',
                                'js/components/books/list/book_list.js'
                            ]
                        },
                        {
                            name: 'booksCreateModule',
                            files: [
                                'vendors/iCheck/skins/flat/blue.css',
                                'vendors/iCheck/icheck.min.js',
                                'js/common/directives/icheck.js',
                                'js/components/books/create/book_create.js'
                            ]
                        },
                        {
                            name: 'booksDetailModule',
                            files: [
                                'vendors/iCheck/skins/flat/blue.css',
                                'vendors/iCheck/icheck.min.js',
                                'js/common/directives/icheck.js',
                                'js/components/books/detail/book_detail.js'
                            ]
                        },
                        {
            ...
            .config(['$stateProvider', '$urlRouterProvider', function ($stateProvider, $urlRouterProvider) {
                    ...
                    $stateProvider
                        ...
                        .state({
                            name: 'books.list',
                            url: '/list',
                            templateUrl: 'js/components/books/list/book_list.html',
                            controller: 'BooksListCtrl',
                            resolve: {
                                loadModule: ['$ocLazyLoad', function ($ocLazyLoad) {
                                    return $ocLazyLoad.load('booksListModule');
                                }]
                            }
                        })
                        .state({
                            name: 'books.create',
                            url: '/create',
                            templateUrl: 'js/components/books/create/book_create.html',
                            controller: 'BooksCreateCtrl',
                            resolve: {
                                loadModule: ['$ocLazyLoad', function ($ocLazyLoad) {
                                    return $ocLazyLoad.load('booksCreateModule');
                                }]
                            }
                        })
                        .state({
                            name: 'books.detail',
                            url: '/detail/{id}',
                            templateUrl: 'js/components/books/detail/book_detail.html',
                            controller: 'BooksDetailCtrl',
                            resolve: {
                                loadModule: ['$ocLazyLoad', function ($ocLazyLoad) {
                                    return $ocLazyLoad.load('booksDetailModule');
                                }]
                            }
                        })
                            .state({
