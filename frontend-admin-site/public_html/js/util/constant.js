...
// App config
    ...
    .constant('API', {
        ...
        GET_LIST_BOOK: {path: '/books/filter', method: 'POST'},
        CREATE_BOOK: {path: '/books/create', method: 'POST'},
        UPDATE_BOOK: {path: '/books/update', method: 'POST'},
        DETAIL_BOOK: {path: '/books/detail/', method: 'POST'},
        DELETE_BOOK: {path: '/books/delete/', method: 'POST'},
    ...
    .constant('APIStatus', [
        ...
        {status: 111, mgsKey: 'api.status.111', message: "Bad credential! Wrong username or password "},
